      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-stone-200 dark:border-stone-800 pb-6">
        <div>
          ...
          <p className="text-xs sm:text-sm text-stone-500 mt-1">
            Xin chào <span className="font-semibold text-blue-600">{user.full_name || user.username}</span>! Bạn có {posts.length} bài viết trong hệ thống.
          </p>
        </div>
